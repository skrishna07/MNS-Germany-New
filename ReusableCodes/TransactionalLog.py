...
import datetime
import shutil
from .GetConfigFromSharepoint import download_config_from_sharepoint
...
def generate_transactional_log(db_config,config_dict):
    try:
        ...
        #download_config_from_sharepoint(os.environ.get('relative_url_transaction_log'), config_excel_file_path)
